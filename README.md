...
Selenium for Python can be downloaded via pip, this is the documantation:
...
The only import parts are PATH_HTML and PATH_CHROME_DRIVER. PATH_HTML is where the HTML to scrape can be found and PATH_CHROME_DRIVER is where you enter the
